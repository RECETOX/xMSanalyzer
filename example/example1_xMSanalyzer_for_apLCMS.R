...
result <- try({
      ...
      res.list <- xMSwrapper.apLCMS(
            cdfloc = cdfloc, apLCMS.outloc = apLCMSoutloc, xMSanalyzer.outloc = xMSanalyzeroutloc, min.run.list = c(4, 3),
