...
cdfloc="/Users/karanuppal/Downloads/data1/"
...
apLCMSoutloc="/Users/karanuppal/Downloads/data1/apLCMSoutput/"
...
xMSanalyzeroutloc="/Users/karanuppal/Downloads/data1/xMSanalyzerv2.0.5output/"
...
########xMSanalyzer usage##################
	...
	par(mfrow=c(2,2))
	pdf("Rplots.pdf")	
		res.list<-xMSwrapper.apLCMS(cdfloc=cdfloc, apLCMS.outloc=apLCMSoutloc, xMSanalyzer.outloc=xMSanalyzeroutloc, min.run.list = c(4,3),       
      min.pres.list = c(0.5,0.8), minexp.pct = 0.1, mztol = 10e-6, alignmztol = 10e-6,       
      alignchrtol = NA, numnodes = 6, apLCMSmode="untargeted", known_table=NA, match_tol_ppm=NA,
      run.order.file = NA, max.mz.diff = 15,     
      max.rt.diff = 300, merge.eval.pvalue = 0.05, mergecorthresh = 0.7, deltamzminmax.tol = 30,
      subs = NA, num_replicates = 3, 
      mz.tolerance.dbmatch = 10, adduct.list = NA, samp.filt.thresh = 0.1,  
      feat.filt.thresh = 30, cormethod = "spearman", mult.test.cor = FALSE,         
      missingvalue = 0, ignore.missing = TRUE, filepattern = ".cdf",
      ...
      replacezeroswithNA=TRUE,charge_type=charge_type,syssleep=0.1)               
